...
{
    public class WeakeningMace : CotmFlail
	{
        ...
        public override void AI()
        {
            base.AI();
			Dust dust;
			dust = Main.dust[Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.CorruptTorch, Projectile.velocity.X * 0.4f, Projectile.velocity.Y * 0.4f, 100, default, 0.8f)];
			dust.noGravity = true;
			dust.velocity.X *= 2f;
			dust.velocity.Y *= 2f;
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
			...
			{
				target.AddBuff(BuffID.Weak, 60 * Main.rand.Next(2, 4));
			}
